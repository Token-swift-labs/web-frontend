...
const Feature = (props: Props) => {
  ...
  return (
    <div className="rounded-[30px] border-2 border-[#2F2F2F] relative flex flex-col gap-4 items-center w-[350px] h-[350px] p-8">
      <div className="text-4xl font-bold z-20">{heading}</div>
      <div className="text-center font-[18px] z-20">{description}</div>
      <div className="w-full h-full bg-[#0C0C0E]/50 absolute top-0 left-0 z-10 rounded-[30px]"></div>
      <Image
        src={bgImage}
        alt="ee"
